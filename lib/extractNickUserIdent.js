...
module.exports = text => {
    ...
    if(matches[2]) fullMatch = fullMatch + `!${matches[2]}`;
    if(matches[3]) fullMatch = fullMatch + `@${matches[3]}`;
    if(matches[4]) fullMatch = fullMatch + ` ${matches[4]}`;
