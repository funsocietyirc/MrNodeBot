...
/** Node IRC */
const irc = config.ircClientDebug ? require('../../funsocietyirc-client') : require('funsocietyirc-client');
...
// TODO This may have changed since merging in new branch features
const nickWatcher = scheduler.schedule('maintainPrimaryNick', {
    ...
    if (
        ...
        ) nickserv = nickserv + `@${config.nickserv.host}`;
        // identify
